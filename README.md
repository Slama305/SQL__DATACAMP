...
I'll now prepare and send you both the .txt file in Arabic and the .md file in English.

### 1. Subquery with Semi-Joins and Anti-Joins

#### Semi-Joins

**Example:**

We have two tables: "Employees" and "Projects." We want to extract employees who have managed projects.
...
We want to extract employees who have not managed any projects.
...
### 2. Using Multiple WHERE Clauses

**Example:**

We have an "Employees" table and want to extract employees who work in the "Sales" department and have a salary above 50,000.
...
### 4. Diagnosing Issues with Anti-Joins

**Example:**

We have "Orders" and "Shipments" tables. We want to extract orders that have not yet been shipped.
...
### 5. Subqueries Inside WHERE and SELECT Clauses

#### Example Inside WHERE

**Example:**

We want to extract employees who have a salary higher than the average salary in their department.
...
We want to display each employee's name along with the number of projects they have managed.
